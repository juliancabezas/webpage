...
Adentro viene un .rar que descomprimiremos para obtener la base de datos en .csv, como podemso ver, pesa XXXX mb, no es tanto, pero si estuvieramos ocupando un computador realmente malo no podríamos ni abrirla en excel, ni hablar de una abse de datos de 30 Gb o más
...
Primero definimos la ruta de nuestra base de datos:
...
Se ve algo intimidante la función, pero la verdad no es tan compleja, lo que hace es utilizar
